...
<div class='input-field'>
  ...
  <div class="input-box">
    <div class="antigen">
      ...
      <select class="beautify requiredField single" id="r_hla_a" name="r_hla_a[]" multiple>
    ...
    <div class="antigen">
      ...
      <select class="beautify requiredField single" id="r_hla_b" name="r_hla_b[]" multiple>
        <!-- added requiredField class -->
        <?php
    ...
    <div class="antigen">
      ...
      <select class="beautify single requiredField" id="r_hla_dr" name="r_hla_dr[]" multiple>
        <!-- added requiredField class -->
        <?php
...
<div class="input-field">
  ...
  <div class="input-box">
    <input type="file" id="r_hla-report" name="r_hla-report" class="single">
  </div>
</div>
...
<div class="input-field">
  ...
  <div class="input-box">
    <input type="file" id="r_ua-report" name="r_ua-report" class="single">
  </div>
</div>