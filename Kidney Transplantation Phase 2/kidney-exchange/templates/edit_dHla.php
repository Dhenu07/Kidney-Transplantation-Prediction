...
<div class='input-field'>
  ...
  <div class="input-box">
    <div class="antigen">
      ...
      <select class="beautify requiredField single" id="d_hla_a" name="d_hla_a[]" multiple>
    ...
    <div class="antigen">
      ...
      <select class="beautify requiredField single" id="d_hla_b" name="d_hla_b[]" multiple>
        <!-- added requiredField class -->
        <?php
    ...
    <div class="antigen">
      ...
      <select class="beautify single requiredField" id="d_hla_dr" name="d_hla_dr[]" multiple>
        <!-- added requiredField class -->
        <?php
...
<div class="input-field">
  ...
  <div class="input-box">
    <input type="file" id="d_hla-report" name="d_hla-report" class="single">
  </div>
</div>